...
| `queued` | Accepted, waiting for Orchestrator capacity. |
| `running` | An Orchestrator run is active; events streaming. |
...
- Define who/what triggers each transition (user action vs. Orchestrator event vs. PR
  webhook).
