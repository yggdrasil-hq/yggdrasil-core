...
| [`adr/005-github-app-repository-access.md`](adr/005-github-app-repository-access.md) | You need the *rationale* for GitHub App repo access vs OAuth. |
...
| [`conventions/design-wireframes.md`](conventions/design-wireframes.md) | Working in the meta-repo `design/` directory (static wireframes of the Web app's own pages). |
